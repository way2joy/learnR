...
```
##   순번 광역단체 기초단체 토건예산.2009년. 토건예산.2012년. 토건예산증감.p.
...
##   복지예산.2009년. 복지예산.2012년. 복지예산증감.p.
## 1             22.1             26.6             4.5
## 2             18.6             26.3             7.7
## 3             23.6             28.6             5.0
## 4             22.1             34.9            12.8
...
##  $ 토건예산.2009년.                       : num  21.4 36.4 33.5 34.4 27.9 ...
##  $ 토건예산.2012년.                       : num  12.7 20 18.5 15 19.9 ...
##  $ 토건예산증감.p.                        : num  -8.7 -16.44 -15.04 -19.4 -7.92 ...
##  $ 복지예산.2009년.                       : num  22.1 18.6 23.6 22.1 23.6 31.6 29.1 39.7 33.7 40.7 ...
##  $ 복지예산.2012년.                       : num  26.6 26.3 28.6 34.9 33 37.3 38.4 46.9 43.5 47.7 ...
##  $ 복지예산증감.p.                        : num  4.5 7.7 5 12.8 9.4 5.7 9.3 7.2 9.8 7 ...
##  $ X10만명.당.자살자수.2012년..연령표준화.: num  21.2 14.2 25.3 23 23.1 16 24.9 23.4 19.3 23 ...
```
...
##                  (Other):100   (Other):200                   
##  토건예산.2012년. 토건예산증감.p.  복지예산.2009년. 복지예산.2012년.
...
##                                                                     
##  복지예산증감.p. X10만명.당.자살자수.2012년..연령표준화.
##  Min.   :-7.60   Min.   : 7.2                           
